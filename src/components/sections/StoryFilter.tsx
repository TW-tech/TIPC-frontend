...
export default function StoryFilter({ onFilterChange, activeFilter }: StoryFilterProps) {
  const filters = [
    { 
      key: "食", 
      label: "食", 
  ...
  return (
   <div className="w-full overflow-x-auto scrollbar-hide">
      <div className="flex items-center gap-2 sm:gap-3 md:gap-4 min-w-max sm:min-w-0 sm:flex-wrap sm:justify-center px-2 sm:px-0">
        {filters.map((filter) => (
          <button 
            key={filter.key}
            onClick={() => {
            ...
            className={`flex flex-col sm:flex-row items-center gap-1 sm:gap-2 md:gap-3 transition-all duration-200 px-3 py-2 sm:px-4 sm:py-2.5 whitespace-nowrap rounded-lg ${

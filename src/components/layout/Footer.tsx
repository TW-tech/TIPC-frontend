          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-1">
            <Link 
              ...
              <Image
                ...
                width={140}
                height={20}
                className="w-[300px]  h-auto filter"
              />
            </Link>
            <p className="text-center lg:text-left text-xs sm:text-sm lg:text-base text-gray-400 mb-2 sm:mb-3 lg:mb-4 leading-relaxed">
              因為我們擁有共同的文化記憶，所以我們成為一家人。
            </p>
            <div className="flex justify-center lg:justify-start space-x-2 sm:space-x-3 lg:space-x-4">
            ...
            <div className="flex justify-center lg:justify-start items-center mb-2 sm:mb-3 lg:mb-4">
              <Image
                src="/icons/草山_logo_text.png"
                alt="Cultural Website Logo"
                width={140}
                height={20}
                className="w-[300px] h-auto mt-4 "
              />
            </div>
          </div>
